    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            for val_data in validate_loader:
                val_images, val_label, _  = val_data  # 左右分支
        ...
        if val_accurate > best_acc:
            ...
            best_epoch = epoch
            save_path = '/home/tanzl/code/VCUG_retrain/result0725_single_all/{}_best.pth'.format(model_name)
            torch.save(net.state_dict(), save_path) 
        save_path = '/home/tanzl/code/VCUG_retrain/result0725_single_all/{}_last.pth'.format(model_name)
        torch.save(net.state_dict(), save_path) 
